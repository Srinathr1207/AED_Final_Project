...
public class GeneralCaseManagementJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblGeneralWardPanel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblGeneralWardPanel.setText("General Ward");
        add(lblGeneralWardPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(-4, 20, 910, -1));
        ...
        lblPatientStatus.setFont(new java.awt.Font("sansserif", 1, 18)); // NOI18N
        lblPatientStatus.setText("Patient Status:");
        add(lblPatientStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 90, -1, -1));

        tblGeneralWard.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 280, 660, 160));

        btnAdmitPatient.setBackground(new java.awt.Color(153, 255, 102));
        ...
        add(btnAdmitPatient, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 470, -1, 40));

        lblEMTTechName.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        lblEMTTechName.setText("EMT Technician Name:");
        add(lblEMTTechName, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 140, -1, -1));

        lblDisplayEMTTechName.setText("jLabel13");
        add(lblDisplayEMTTechName, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 140, -1, -1));

        lblAmbulanceNum.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        lblAmbulanceNum.setText("Ambulance number:");
        add(lblAmbulanceNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 180, -1, -1));

        lblDisplayAmbNum.setText("jLabel14");
        add(lblDisplayAmbNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 180, -1, -1));

        lblNPINum.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        lblNPINum.setText("NPI Number:");
        add(lblNPINum, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 220, -1, -1));

        lblDisplayNPINum.setText("jLabel15");
        add(lblDisplayNPINum, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 220, -1, -1));

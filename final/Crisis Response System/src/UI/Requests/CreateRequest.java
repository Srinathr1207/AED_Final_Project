...
public class CreateRequest extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        entityAreaField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                entityAreaFieldActionPerformed(evt);
            }
        });
        ...
        add(openmap, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 300, -1, -1));
    ...
    private void btnGetUnitsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGetUnitsActionPerformed
        ...
        try{
            ...
            message.setText("An Request is created on behalf of you by Admin" 
                            ...
                            + "\n\n If this is not you then contact +1 (123)456-789 or email to teamrjs@gmail.com");
  ...
  // TODO add your handling code here:
    ...
    private void entityAreaFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_entityAreaFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_entityAreaFieldActionPerformed

    private void openmapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_openmapActionPerformed
        // TODO add your handling code here:
       String latitude = "42.340827"; // Set latitude of the location
    String longitude = "-71.087122"; // Set longitude of the location
    String zoom = "15"; // Set the zoom level (optional)
    
    // Construct the URL for displaying the map with live location
    String url = "https://www.google.com/maps/search/?api=1&query=" + latitude + "," + longitude + "&zoom=" + zoom;
...
private void currentTime() {
    ...
    private void getAreas() {
        System.out.println(ecoSystem.getAreaDirectory().getAreasList());

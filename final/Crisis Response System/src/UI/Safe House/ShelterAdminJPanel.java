...
public class ShelterAdminJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(lblAssignedRequests, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, -1, -1));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 880, 140));

        btnNext.setBackground(new java.awt.Color(0, 153, 153));
        btnNext.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        btnNext.setForeground(new java.awt.Color(0, 153, 153));
        ...
        add(btnNext, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 320, -1, 30));

...
public class FireDepartmentAdmin extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 900, 40));

        lblFactoryFire.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        lblFactoryFire.setText("Factory Fire Emergency");
        add(lblFactoryFire, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 90, -1, -1));

        lblHouseEmergency.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        lblHouseEmergency.setText("House Fire Emergency");
        add(lblHouseEmergency, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 260, -1, -1));

        btnProceed.setBackground(new java.awt.Color(255, 51, 51));
        ...
        add(btnProceed, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 350, 90, 30));
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 620, 110, 30));

        lblHouseUn.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        lblHouseUn.setText("Unit Number:");
        add(lblHouseUn, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 320, -1, -1));

        lblFactoryUn.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        lblFactoryUn.setText("Unit Number:");
        add(lblFactoryUn, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 140, -1, -1));
        add(txtHouseUN, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 320, 210, -1));
        add(txtFactoryUN, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 140, 210, -1));
        ...
        add(btnAddFf, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 170, -1, 30));
        ...
        add(btnHf, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 350, -1, 30));

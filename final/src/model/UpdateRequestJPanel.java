...
public class UpdateRequestJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, -1, 30));

        jLabel2.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        jLabel2.setText("Name");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 130, -1, -1));
        add(entityNameField, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 130, 191, -1));
        ...
        add(entityLocationField, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 160, 191, -1));

        jLabel8.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        jLabel8.setText("Area");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 190, -1, -1));

        add(entityAreaField, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 200, 191, -1));

        jLabel6.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        jLabel6.setText("Selected Item");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 240, -1, -1));
        add(entityTypeOfEmergency, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 350, 277, 17));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 280, 260, -1));

        jLabel5.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        jLabel5.setText("Status");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 390, -1, -1));
        ...
        add(statusDD, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 390, 200, -1));

        lblReqID.setText("jLabel9");
        add(lblReqID, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 120, -1, -1));

        jLabel9.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        jLabel9.setText("Selected Hospital");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 430, -1, -1));

        lblSelectedHos.setText("jLabel10");
        add(lblSelectedHos, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 430, 274, -1));

        lblSelectedPD.setText("jLabel10");
        add(lblSelectedPD, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 490, 274, -1));

        jLabel10.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        jLabel10.setText("Selected Police Department");
        add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 490, -1, -1));

        lblSelectedFD.setText("jLabel10");
        add(lblSelectedFD, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 540, 274, -1));
        ...
        add(lblSelectedShel, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 580, 274, -1));

        jLabel12.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        jLabel12.setText("Selected Shelter ");
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 580, -1, -1));
        ...
        add(btnProceed, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 630, -1, 30));

        jLabel4.setFont(new java.awt.Font("Lucida Grande", 3, 24)); // NOI18N
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("Update Request");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 900, 30));

        jLabel14.setText("RequestID:");
        add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, -1, -1));

        lbltimestamp.setText("jLabel1");
        add(lbltimestamp, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, -1, -1));
